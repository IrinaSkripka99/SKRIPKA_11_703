                        ...
                        <form action="" id="add_persons" method="post" onsubmit="addRow(1);return false;">
                            <fieldset>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input step="any" required type="number" min="1" max="10000" name="weight"
                                           id="weight" value="" size="12" tabindex="2" class="form-control "/>
                                </div>

                                <label for="name2">Какой продукт?</label>
                                <select id="name2">
                                    <option value=1>Арахис</option>
                                    <option value=2>Яблоко</option>
                                    <option value=3>Баранина</option>
                                    <option value=4>Макароны</option>
                                </select>

                                <div style="margin-top: 15px"><input title=""
                                    ...
                                    <input type="submit" name="subm" class="submit btn btn-success" value="Очистить"
                                           onclick="sendProductId(100);return false;" tabindex="3"/>
                                </div>

                            </fieldset>
                        </form>
                        <form style="margin-top: 15px" id="checkUser">
                            <fieldset>
                                <legend>Получить советы</legend>
                                <div class="form-group col-md-6">
                                    <label for="userWeight">Вес, кг.</label>
                                    <input step="any" required type="number" min="10" max="400" name="userWeight"
                                           id="userWeight" value="" size="12" tabindex="2" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="height">Рост, см.</label>
                                    <input step="any" required type="number" min="1" max="250" name="height" id="height"
                                           value="" size="12" tabindex="2" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="age">Возраст</label>
                                    <input step="any" required type="number" min="1" max="150" name="age" id="age"
                                           value="" size="12" tabindex="2" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <input data-toggle="modal" data-target="#modal-notification" type="submit"
                                           name="subm" onclick="checkUser();return false;" class="submit btn btn-success" value="Получить совет"
                                           tabindex="3"/>
                                </div>
                            </fieldset>
                        </form>
