    ...
    <div class="wrap-login100" style="padding: 50px 130px 33px 95px">
      ...
      <%--<div class="buttons" style="font-size: 10px">--%>
        <%--<div class="container-login100-form-btn" >--%>
          <%--<button class="login100-form-btn" href="../jsp/shop.jsp" type="submit" value="Сделать заказ"></button>--%>
        <%--</div>--%>
        <%--<div class="container-login100-form-btn" >--%>
          <%--<input class="login100-form-btn" href="main.jsp" type="submit" value="Узнать свое БЖУ">--%>
        <%--</div>--%>
      <%--</div>--%>
